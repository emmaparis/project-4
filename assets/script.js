...
var questions = [
    {
        prompt: "How do you insert comments in JavaScript? ",
        options: ["</>", "<#>", "<*>", "<//>"],
        answer: "<//>"
    },

    {
        prompt: "Which data type is used to create a variable that should store text?",
        options: ["txt", "string", "var", "const"],
        answer: "string"
    },

    {
        prompt: "Which method can be used to find the length of a string??",
        options: ["getSize", "len()", "length()", "getLength()"],
        answer: "length()"
    },

    {
        prompt: "In JavaScript, how do you call a method?",
